...
dat_suffix = ['Toro', 'Edin', 'Glas', 'Osak']
# , 'weeplaces_poi_1000_length_9', 'weeplaces_poi_101_length_9'
...
for filename in dat_suffix:
    ...
    train_data.to_csv(f"{final_dir}/trian.csv", index = False, sep = "|", header = False)
    test_data.to_csv(f"{final_dir}/test.csv", index = False, sep = "|", header = False)
