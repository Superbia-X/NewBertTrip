...
def get_model(model_name):
    from bert.bert_model import BertForMaskedLM as PureBERT
    from bert.bert_siam import SiamBERT
    from bert.bert_temporal import TemporalBERT
    from bert.bert_trip import TripBERT
